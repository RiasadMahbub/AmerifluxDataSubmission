...
**Code repository:** https://github.com/RiasadMahbub/PostProcessingECdataLandscapeFlux/tree/main/AmerifluDataSubmission_LandscapeFlux
...
![Data processing pipeline](Processflowimage.png)
...
![Wind Speed Comparison — Way 3, 2021](Way3_WindSpeed_2021.png)
...
![AmeriFlux positional qualifier convention](positionqualifiers.png)
...
When PPFD_IN peaks earlier or later than SW_IN and SW_IN_POT, a timestamp offset is applied. The before/after plots for Way 4, 2019 illustrate this: in the uncorrected data (left), PPFD_IN in periods 22–25 leads SW_IN by several hours; after correction (right), the curves are aligned.

**Before correction:**

![Radiation plot before timestamp fix — Way 4, 2019](Way4_2019_RadiationPlotbefore.jpeg)

**After correction:**

![Radiation plot after timestamp fix — Way 4, 2019](Way4_2019_RadiationPlot.jpeg)
...
![Physical range of FC — 2024](physicalrange.png)
...
![AmeriFlux submission protocols](positionqualifiers.png)
...
![Data coverage — US-HRA](US-HRA-variable_coverage-by_year.png)

**US-HRC (Way 3):**

![Data coverage — US-HRC](US-HRC-variable_coverage-by_year.png)
