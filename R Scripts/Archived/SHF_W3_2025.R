## ========================================================================== ##
## PROJECT: Soil Heat Flux (G) Calculation - Way 3 | 2025                     ##
## AUTHOR: Riasad Bin Mahbub                                                  ##
## DESCRIPTION: High-Efficiency + Robust Nearest Join Implementation          ##
## ========================================================================== ##
...
site <- "Way3"
year <- "2025"
fig_dir <- "C:/Users/rbmahbub/Documents/RProjects/AmerifluxDataSubmission_LandscapeFlux/SoilHeatFluxCalculation/Figures/EachColumn/Way3_2025"
if (!dir.exists(fig_dir)) dir.create(fig_dir, recursive = TRUE)

flux_file <- "C:/Users/rbmahbub/Documents/RProjects/AmerifluxDataSubmission_LandscapeFlux/Data/ForLabResearachPurposeMoreColumns/Way3/Way3_2025.csv"
wtd_file  <- "C:/Users/rbmahbub/Documents/RProjects/AmerifluxDataSubmission_LandscapeFlux/Data/InputLocalRawData/WTD/2025_way3_ECside.xlsx"
...
## --- CALCULATION & PLOTTING (Consistent with Way3 2024 logic) ---
rho_soil <- 1300; Cp_dry <- 900; Cp_water <- 4190; rho_water <- 1000; plate_depth <- 0.05; t_interval <- 1800
...
s_soil <- ifelse(df$is_flooded, 
                 ((df$del_TS_2 + df$del_TS_3)/2) * 0.05 * (1000 * 4190) / 1800, 
                 ((df$del_TS_2 + df$del_TS_3)/2) * 0.05 * Cs_dry / 1800)
...
## --- OUTPUT ---
ggsave(file.path(fig_dir, "01_Final_Gavg.png"), 
       ggplot(df, aes(time_join, Gavg)) + 
         geom_line(color="red") + 
         theme_bw(), 
       width=10, height=5)
